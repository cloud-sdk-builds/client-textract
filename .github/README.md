...
[`@aws-sdk/client-textract`](https://www.npmjs.com/package/@aws-sdk/client-textract/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-textract@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X/fmWwa62EueDckyYICjHtt0toKABOFZMS2BBVYyFVzkfddVhiqK1enewVgemDAA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-textract": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-textract@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-textract@3.631.0/index.min.mjs": "sha384-X/fmWwa62EueDckyYICjHtt0toKABOFZMS2BBVYyFVzkfddVhiqK1enewVgemDAA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-textract/blob/refs/tags/3.631.0/LICENSE
```
